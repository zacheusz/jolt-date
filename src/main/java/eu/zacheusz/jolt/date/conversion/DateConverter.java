package eu.zacheusz.jolt.date.conversion;
/*************************************************/
/* code refactored from com.thoughtworks.xstream */
/*************************************************/
...
public class DateConverter {
    ...
    static {
        ...
        boolean canParseISO8601TimeZoneInDateFormat;
        try {
            new SimpleDateFormat("X").parse("Z");
            canParseISO8601TimeZoneInDateFormat = true;
        } catch (final ParseException e) {
            canParseISO8601TimeZoneInDateFormat = false;
        } catch (final IllegalArgumentException e) {
            canParseISO8601TimeZoneInDateFormat = false;
        }

        if (canParseISO8601TimeZoneInDateFormat) {
